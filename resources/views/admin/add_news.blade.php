...
@section('content')
    ...
    <div class="container" >
        <div align="center" class="align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"  style="text-align:center">إضافة خبر</h1>
        </div>
        <br>
            <div class="container">
                    ...
                    @csrf
                        <div class="row g-2">
                            ...
                            <div class="col-md-12" align="right">
                                ...
                                <textarea  class="form-control" style="text-align: right" rows="3" name="intro" ></textarea>
                                @error('intro')
                                    <span style="color:red;" align="center">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-12" align="right">
                                ...
                                <textarea  class="form-control" rows="6" name="show" ></textarea>
                                @error('show')
                                    <span style="color:red;" align="center">{{ $message }}</span>
                                @enderror
                            </div>
